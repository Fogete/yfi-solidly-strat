...
contract Strategy is BaseStrategy {
    ...
    IERC20 internal constant yfi = IERC20(0x29b0Da86e484E1C0029B56e817912d778aC0EC69);
    IERC20 internal constant woofy = IERC20(0xD0660cD418a64a1d44E9214ad8e459324D8157f1);
    ...
    ILpDepositer internal constant lpDepositer = ILpDepositer(0x26E1A0d851CF28E697870e1b7F053B605C8b060F);
        ...
        returns (address token, uint256 amount)
    {
        ...
        // If lp is unbalanced we need to arb it back to peg. 
        // If too much yfi in lp buy yfi. 
        // If too much woofy buy woofy.
